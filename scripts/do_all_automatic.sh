...
echo "  Prod readiness:    ./scripts/prod_readiness_check.sh"
echo "  Prod readiness CI: ./scripts/prod_readiness_ci.sh"
echo "  Prod handoff:      ./scripts/prod_handoff_after_release.sh"
