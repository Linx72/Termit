...
1. Roll back to previous stable tag (`v0.4.24`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.24`.
...
- Incident: "Rolled back from v0.4.25 to v0.4.24 due to <reason>."
