# Migration Notes 0.3.9

## Scope

Structured JSON logs, provider/verify trace spans, Media Studio confirm UI

Previous stable: `v0.3.8`.

## Configuration changes

- Review `.env.example` for new or renamed keys since `v0.3.8`.
