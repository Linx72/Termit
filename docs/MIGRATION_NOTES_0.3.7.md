# Migration Notes 0.3.7

## Scope

Finetune loop closure: eval KPI gate (+5%), stage1_full_loop promote wiring

Previous stable: `v0.3.6`.

## Configuration changes

- Review `.env.example` for new or renamed keys since `v0.3.6`.
