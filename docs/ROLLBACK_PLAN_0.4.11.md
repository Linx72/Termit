...
1. Roll back to previous stable tag (`v0.4.10`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.10`.
...
- Incident: "Rolled back from v0.4.11 to v0.4.10 due to <reason>."
