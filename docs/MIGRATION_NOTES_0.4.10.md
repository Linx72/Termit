# Migration Notes 0.4.10

## Scope

Stability and product improvements for Termit 0.4.10.

Previous stable: `v0.4.9`.

## Configuration changes

- Review `.env.example` for new or renamed keys since `v0.4.9`.
