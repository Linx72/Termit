# Migration Notes 0.3.6

## Scope

SLO/Grafana stack, DLQ UI, desktop runtime bar, release discipline

Previous stable: `v0.3.5`.

## Configuration changes

- Review `.env.example` for new or renamed keys since `v0.3.5`.
