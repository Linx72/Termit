...
1. Roll back to previous stable tag (`v0.4.19`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.19`.
...
- Incident: "Rolled back from v0.4.20 to v0.4.19 due to <reason>."
