# Migration Notes 0.4.11

## Scope

Stability and product improvements for Termit 0.4.11.

Previous stable: `v0.4.10`.

## Configuration changes

- Review `.env.example` for new or renamed keys since `v0.4.10`.
