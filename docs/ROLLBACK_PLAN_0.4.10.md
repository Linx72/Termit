...
1. Roll back to previous stable tag (`v0.4.9`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.9`.
...
- Incident: "Rolled back from v0.4.10 to v0.4.9 due to <reason>."
