...
1. Roll back to previous stable tag (`v0.3.6`).
...
- Check commit history for SQLite schema or data migrations since `v0.3.6`.
...
- Incident: "Rolled back from v0.3.7 to v0.3.6 due to <reason>."
