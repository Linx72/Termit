# Migration Notes 0.3.8

## Scope

Desktop North Star UX (WorkflowHub, KPI gates), eval pass by category metrics, Prometheus alert fixes

Previous stable: `v0.3.7`.

## Configuration changes

- Review `.env.example` for new or renamed keys since `v0.3.7`.
