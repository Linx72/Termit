...
1. Roll back to previous stable tag (`v0.3.7`).
...
- Check commit history for SQLite schema or data migrations since `v0.3.7`.
...
- Incident: "Rolled back from v0.3.8 to v0.3.7 due to <reason>."
