...
1. Roll back to previous stable tag (`v0.4.22`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.22`.
...
- Incident: "Rolled back from v0.4.23 to v0.4.22 due to <reason>."
