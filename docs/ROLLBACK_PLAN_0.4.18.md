...
1. Roll back to previous stable tag (`v0.4.17`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.17`.
...
- Incident: "Rolled back from v0.4.18 to v0.4.17 due to <reason>."
