...
1. Roll back to previous stable tag (`v0.3.8`).
...
- Check commit history for SQLite schema or data migrations since `v0.3.8`.
...
- Incident: "Rolled back from v0.3.9 to v0.3.8 due to <reason>."
