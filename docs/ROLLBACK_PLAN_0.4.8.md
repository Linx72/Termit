...
1. Roll back to previous stable tag (`v0.4.7`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.7`.
...
- Incident: "Rolled back from v0.4.8 to v0.4.7 due to <reason>."
