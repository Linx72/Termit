...
1. Roll back to previous stable tag (`v0.4.6`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.6`.
...
- Incident: "Rolled back from v0.4.7 to v0.4.6 due to <reason>."
