...
1. Roll back to previous stable tag (`v0.4.2`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.2`.
...
- Incident: "Rolled back from v0.4.3 to v0.4.2 due to <reason>."
