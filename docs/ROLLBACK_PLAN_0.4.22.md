...
1. Roll back to previous stable tag (`v0.4.21`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.21`.
...
- Incident: "Rolled back from v0.4.22 to v0.4.21 due to <reason>."
