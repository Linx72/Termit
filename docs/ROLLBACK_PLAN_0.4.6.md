...
1. Roll back to previous stable tag (`v0.4.5`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.5`.
...
- Incident: "Rolled back from v0.4.6 to v0.4.5 due to <reason>."
