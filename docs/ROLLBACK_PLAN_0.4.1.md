...
1. Roll back to previous stable tag (`v0.4.0`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.0`.
...
- Incident: "Rolled back from v0.4.1 to v0.4.0 due to <reason>."
