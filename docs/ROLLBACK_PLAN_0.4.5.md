...
1. Roll back to previous stable tag (`v0.4.4`).
...
- Check commit history for SQLite schema or data migrations since `v0.4.4`.
...
- Incident: "Rolled back from v0.4.5 to v0.4.4 due to <reason>."
