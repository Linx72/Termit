window.TERMIT_I18N = {
  en: {
    ...
    agentHub: {
      ...
      chartOrchestrationRetry: "Retry success (orchestration)",
      ...
      collectingRetry: "Collecting retry trend...",
      workersAlive: "alive",
      workersDown: "down",
      stateQueued: "queued",
...
curl -s http://127.0.0.1:8765/api/ops/agent-runs/metrics</span>`,
  ...
  ru: {
    ...
    agentHub: {
      ...
      chartOrchestrationRetry: "Успех retry (orchestration)",
      ...
      collectingRetry: "Сбор тренда retry...",
      workersAlive: "живые",
      workersDown: "offline",
